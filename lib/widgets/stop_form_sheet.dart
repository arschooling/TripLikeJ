...
class StopFormState extends State<StopFormContent> {
  ...
  Widget _field(BuildContext context, String label, TextEditingController ctrl,
    ...
    return Column(
      ...
      children: [
        Text(label, style: AppText.sans(16, color: c.mute)),
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text('시간', style: AppText.sans(16, color: c.mute)),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    _time.isEmpty ? '--:--' : _time,
                    style: AppText.mono(16, color: c.ink, letterSpacing: 1),
                  ),
                ),
              ),
            ],
          ...
          // Category chips
          Text('카테고리', style: AppText.sans(16, color: c.mute)),
