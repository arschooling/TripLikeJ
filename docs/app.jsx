  ...
  return (
    <div style={{ minHeight:'100vh', background:COLORS.bg, paddingBottom:90, position:'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily:SERIF, fontSize:34, color:COLORS.ink, letterSpacing:'-0.02em' }}>My Trips<span style={{fontFamily:'monospace',fontSize:12,color:COLORS.mute,marginLeft:8}}>v218</span></div>
      </div>
    ...
    <div style={{ minHeight:'100vh', background:'#1a1a1a', display:'flex', flexDirection:'column',
      ...
      <div style={{ background:'#C0392B', borderRadius:16, padding:'20px 24px', maxWidth:320, textAlign:'center', width:'100%' }}>
        <div style={{ fontFamily:MONO, fontSize:17, color:'#fff', lineHeight:2.2 }}>
          ...
          <div style={{ fontSize:12, marginTop:4, opacity:0.8 }}>v218</div>
        </div>
      </div>
      <button onClick={async () => {
        try {
