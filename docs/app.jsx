    ...
    return (
      <>
        <div style={{ padding:'0 14px 2px', display:'grid', gridTemplateColumns:'repeat(7, 1fr)' }}>
          {DOW.map((w, i) => (
            <div key={i} style={{ textAlign:'center', fontFamily:MONO, fontSize:15, letterSpacing:'0.08em',
        ...
        {['start','end'].map((k,ki) => {
          ...
          return (
            <button key={k} onClick={()=>{ setPicking(k); setShowYM(false); }} style={{
              ...
              <div style={{fontFamily:MONO, fontSize:15, letterSpacing:'0.12em', marginBottom:3,
      ...
      {showYM ? (
        ...
        <>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(7,1fr)', padding:'0 14px 2px'}}>
            {DOW.map((w,i) => (
              <div key={i} style={{textAlign:'center', fontFamily:MONO, fontSize:15, letterSpacing:'0.08em', padding:'2px 0 6px',
  ...
  const ModeTab = ({ id, emoji, label, desc }) => {
    ...
    return (
      <div onClick={() => setMode(id)} style={{
        ...
        <div style={{ fontFamily:SANS, fontSize:15, color: active ? 'rgba(255,255,255,0.65)' : COLORS.mute,
    ...
    <div style={{ position:'fixed', inset:0, zIndex:400, background:'rgba(0,0,0,0.4)',
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ flexShrink:0 }}>
          <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.accent, letterSpacing:'0.14em', marginBottom:4 }}>SHARE TRIP</div>
          ...
          {loading ? (
            ...
            <>
              {memberProfiles.length > 0 && (
                <>
                  <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, letterSpacing:'0.08em',
                  ...
                  {memberProfiles.map(c => (
                    <div key={c.uid} style={{
                      ...
                      <div style={{ flex:1, minWidth:0 }}>
                        ...
                        <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute,
  ...
  return (
    <div style={{ minHeight:'100vh', background:COLORS.bg, paddingBottom:90, position:'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily:SERIF, fontSize:34, color:COLORS.ink, letterSpacing:'-0.02em' }}>My Trips<span style={{fontFamily:'monospace',fontSize:12,color:COLORS.mute,marginLeft:8}}>v222</span></div>
      </div>
    ...
    return (
      <button key={item.name} onClick={() => window.open(mapsSearchUrl(item.name), '_blank')}
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          {item.nameOrig && <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginTop:1, whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' }}>{item.nameOrig}</div>}
          <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, marginTop:3, display:'flex', gap:6, alignItems:'center' }}>
          ...
          <div style={{ display:'flex', gap:8, alignItems:'center', flexShrink:0 }}>
            <button onClick={() => setSort(s => s === 'relevance' ? 'distance' : 'relevance')}
              style={{ border:'none', background:COLORS.softer, borderRadius:10, padding:'6px 10px',
                fontFamily:MONO, fontSize:15, cursor:'pointer', letterSpacing:'0.04em',
    ...
    <div style={{ position:'fixed', inset:0, zIndex:1000,
      ...
      <div ref={sheetRef} onClick={(e)=>e.stopPropagation()}
        ...
        <div style={{ padding:'18px 20px 0' }}>
          <div style={{ display:'flex', gap:6, alignItems:'center',
            fontFamily:MONO, fontSize:15, color:COLORS.mute,
            letterSpacing:'0.12em', textTransform:'uppercase' }}>
              ...
              <div style={{ marginTop:16, display:'flex', flexDirection:'column' }}>
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ flex:1 }}>
                      <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute,
                        letterSpacing:'0.12em', textTransform:'uppercase' }}>{r.label}</div>
                      <div style={{ marginTop:2, fontFamily:SANS, fontSize:17, color:COLORS.ink,
...
function HotelSheet({ open, onClose, hotel, trip, tripDays, onSave, onDelete, onRegisterEdit, onTabBarToggle }) {
  ...
  const field = (key, label, placeholder = '') => (
    <div style={{ marginBottom:10 }}>
      <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:4 }}>{label}</div>
    ...
    <div style={{ position:'fixed', inset:0, zIndex:1000,
      ...
      <div style={{ transform:`translateY(${entered ? sheetY : window.innerHeight}px)`,
        ...
        <div ref={sheetRef} onClick={e => e.stopPropagation()}
          ...
          <div style={{ padding:'18px 20px 0' }}>
            <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.accent, letterSpacing:'0.12em', textTransform:'uppercase' }}>
            ...
            {editing ? (
              <div style={{ marginTop:14 }}>
                <div style={{ position:'relative', marginBottom:10 }}>
                  <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:4 }}>{t('wizHotelPh')}</div>
                  <div style={{ position:'relative' }}>
                    <input
                      ...
                      {searchRes.map((f, i) => {
                        ...
                        return (
                          <button key={i}
                            ...
                            {city && <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginTop:1 }}>{[addr, city].filter(Boolean).join(', ')}</div>}
                          </button>
                        );
                      })}
                    </div>
                ...
                <div style={{ background:COLORS.card, borderRadius:14, padding:'14px 16px' }}>
                  ...
                  <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginBottom:10 }}>
                    {['checkin','checkout'].map(k => (
                      <div key={k}>
                        <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:4 }}>
                  ...
                  <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
                    <div>
                      <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:4 }}>박수</div>
                  ...
                  <div>
                    <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:4 }}>메모</div>
              ...
              <div style={{ marginTop:16, display:'flex', flexDirection:'column' }}>
                {rows.map((r, i, arr) => (
                  <div key={i} style={{
                    ...
                    <div style={{ flex:1 }}>
                      <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.12em', textTransform:'uppercase' }}>{r.label}</div>
        ...
        {timePicker && (
          <div onClick={() => setTimePicker(null)} style={{
            ...
            <div onClick={e => e.stopPropagation()} style={{
              ...
              <div style={{ padding:'4px 20px 10px', fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.1em', textTransform:'uppercase' }}>
          ...
          return (
            <button key={i} onClick={() => onPick({ name, addr, coords:[lat, lon] })} style={{
              ...
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ fontFamily:SANS, fontSize:17, fontWeight:500, color:COLORS.ink,
                  whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' }}>{name}</div>
                {addr ? <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginTop:2,
    ...
    <div style={{ position:'fixed', inset:0, zIndex:310,
      ...
      <div ref={sheetRef} onClick={e=>e.stopPropagation()} style={{
        ...
        {sharedCurs.map(([cur, {out}]) => {
          ...
          return (
            <div key={cur} style={{ background:COLORS.card, borderRadius:14, padding:'12px 16px', marginBottom:8 }}>
              <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.1em', textTransform:'uppercase', marginBottom:6 }}>{cur} 공동 지출</div>
              <div style={{ display:'flex', alignItems:'baseline', justifyContent:'space-between' }}>
                <div style={{ fontFamily:SERIF, fontSize:18, color:COLORS.ink }}>{fmtAmt(out, cur)}</div>
                <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute }}>÷ {count} =</div>
        ...
        <div style={{ background:COLORS.card, borderRadius:14, padding:'14px 16px', marginBottom:14 }}>
          <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.1em', textTransform:'uppercase', marginBottom:8 }}>인원 수</div>
      ...
      {tab === 'export' ? (
        <div style={{ padding:'0 16px 24px' }}>
          {entries.length === 0 ? (
            ...
            <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, marginBottom:8 }}>
            ...
            <textarea readOnly value={toTsv}
              ...
              style={{
                ...
                fontSize:15, fontFamily:MONO, color:COLORS.ink, background:COLORS.soft,
            ...
            <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginTop:10, textAlign:'center' }}>
        ...
        <div style={{ padding:'0 16px 24px' }}>
          <div style={{ fontFamily:SANS, fontSize:15.5, color:COLORS.mute, marginBottom:10, lineHeight:1.6 }}>
          ...
          {entries.length > 0 && importText.trim() && (
            <div style={{ marginBottom:10, padding:'8px 12px', borderRadius:10,
              background:'rgba(200,80,80,0.08)', fontFamily:SANS, fontSize:15.5, color:COLORS.accent }}>
          ...
          <textarea
            ...
            style={{
              ...
              border:`1.5px solid ${COLORS.line}`, fontFamily:MONO, fontSize:15,
            ...
            const makeAirportInput = (value, setValue, label, isAutoFocus, placeholder) => {
              ...
              return (
                <div style={{ marginBottom:18 }}>
                  <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginBottom:6, textTransform:'uppercase', letterSpacing:'0.05em' }}>{label}</div>
                  <div style={{ position:'relative', borderRadius:14, background:COLORS.card, border:`1.5px solid ${COLORS.line}` }}>
                    {ghostSuffix && (
                      <div aria-hidden="true" style={{ position:'absolute', inset:0, padding:'12px 40px 12px 16px', display:'flex', alignItems:'center', pointerEvents:'none', overflow:'hidden', fontFamily:SANS, fontSize:17, lineHeight:'normal', borderRadius:14 }}>
                  ...
                  {codeMatch && (
                    <div onMouseDown={e => { e.preventDefault(); setValue(lang === 'ko' ? codeMatch.kor : codeMatch.eng); }}
                      ...
                      <span style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute }}>{codeMatch.code}</span>
              ...
              <div>
                ...
                {!arrAirport && citySuggests.length > 0 && (
                  <div style={{ marginBottom:18, marginTop:-8 }}>
                    <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginBottom:8, textTransform:'uppercase', letterSpacing:'0.05em' }}>
                      ...
                      {citySuggests.map(apt => {
                        ...
                        return (
                          <button key={apt} onMouseDown={e=>e.preventDefault()} onClick={() => setArrAirport(aptName)}
                            style={{ display:'flex', alignItems:'center', gap:6, background:COLORS.card, border:`1.5px solid ${COLORS.line}`, borderRadius:20, padding:'6px 14px 6px 10px', cursor:'pointer', fontFamily:SANS, fontSize:15.5, color:COLORS.ink }}>
                            <span style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:0.5 }}>{info?.code}</span>
                            <span>{aptName}</span>
                          </button>
                        );
                      })}
                ...
                <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, lineHeight:1.5 }}>
                  {t('wizNoFlight')}
                </div>
              </div>
            );
            ...
            <div>
              {!skipHotel && hotels.map((h, i) => (
                <div key={i} style={{ background:COLORS.card, borderRadius:14, padding:'12px 14px', marginBottom:10, border:`1px solid ${COLORS.line}` }}>
                  ...
                  />
                  {dayCount > 1 && (
                    <div style={{ display:'flex', alignItems:'center', gap:8, fontFamily:SANS, fontSize:15, color:COLORS.mute }}>
                      <span>Day</span>
                      <input type="number" min={1} max={dayCount} value={h.from}
                        ...
                        style={{ width:40, textAlign:'center', border:`1px solid ${COLORS.line}`, borderRadius:6, padding:'3px 4px', fontFamily:SANS, fontSize:15, outline:'none' }}
                      />
                      <span>~</span>
          ...
          {step === HP_STEP && (() => {
            ...
            return (
              <div>
                ...
                {!loading && placeErr && (
                  <div style={{ textAlign:'center', padding:'24px 0', fontFamily:SANS, fontSize:15, color:'#E03C31' }}>
                    {placeErr}
                  </div>
                )}
                ...
                {!loading && cityPlaces.length > 0 && (
                  <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginBottom:12 }}>
                    ...
                    return (
                      <button key={p.id} onClick={() => togglePlace(p.id)} style={{
                        ...
                        <div style={{ height:88, position:'relative' }}>
                          ...
                          {p.type === 'hiking_trail' && (
                            <div style={{ position:'absolute', bottom:6, left:7, background:'rgba(0,0,0,0.52)', borderRadius:5, padding:'2px 6px', fontFamily:SANS, fontSize:15, color:'#fff', letterSpacing:0.3 }}>
                              {t('wizHiking')}
                            </div>
                          )}
                          {sel && (
                        ...
                        <div style={{ padding:'7px 9px 9px' }}>
                          <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.ink, lineHeight:1.35, fontWeight: sel ? 600 : 400 }}>{p.name}</div>
                          {p.nameOrig && <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginTop:2, lineHeight:1.2 }}>{p.nameOrig}</div>}
                        </div>
                      </button>
                    );
                  })}
    ...
    <div style={{ position:'fixed', inset:0, zIndex:210, background:'rgba(0,0,0,0.4)',
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding:'6px 20px 16px', borderBottom:`1px solid ${COLORS.line}` }}>
          ...
          <div style={{ fontFamily:SANS, fontSize:15.5, color:COLORS.mute, marginTop:4 }}>
            이메일로 동행인을 추가해요
          </div>
        </div>
        ...
        {pendingInvites.length > 0 && (
          <div style={{ margin:'14px 16px 0', background:'#FFF8E1', borderRadius:14, padding:14 }}>
            <div style={{ fontFamily:MONO, fontSize:15, color:'#B8860B', letterSpacing:'0.1em', marginBottom:8 }}>
            ...
            {pendingInvites.map(inv => (
              <div key={inv.id} style={{ display:'flex', alignItems:'center', gap:10, marginBottom:8 }}>
                ...
                <button onClick={() => handleAccept(inv)} disabled={!!accepting} style={{
                  ...
                  background: accepting === inv.id ? COLORS.mute : COLORS.ink, color:COLORS.bg, fontFamily:SANS, fontSize:15, fontWeight:500,
                ...
                <button onClick={() => fbRejectInvite(inv.id).then(() => setPendingInvites(p=>p.filter(i=>i.id!==inv.id)))} style={{
                  border:`1px solid ${COLORS.line}`, borderRadius:9, padding:'6px 10px', cursor:'pointer',
                  background:'transparent', fontFamily:SANS, fontSize:15, color:COLORS.mute,
                }}>거절</button>
              </div>
            ))}
          </div>
        ...
        <div style={{ padding:'16px 16px 0' }}>
          <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.1em', marginBottom:8 }}>
            여행 선택 (선택사항)
          </div>
          ...
          <div style={{ marginTop:16, fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.1em', marginBottom:8 }}>
            이메일로 초대
          </div>
          <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginBottom:10 }}>
          ...
          <input value={inviteEmail} onChange={e => setInviteEmail(e.target.value)}
            ...
            style={{ width:'100%', padding:'12px 14px', borderRadius:12,
              ...
              fontFamily:SANS, fontSize:17, color:COLORS.ink, boxSizing:'border-box', outline:'none' }}/>
          {inviteMsg && (
            <div style={{ marginTop:8, fontFamily:SANS, fontSize:15,
    ...
    <div style={{ position:'fixed', inset:0, zIndex:210, background:'rgba(0,0,0,0.4)',
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ overflowY:'auto', flex:1, padding:'12px 16px' }}>
          {/* Appearance */}
          <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.1em', textTransform:'uppercase', marginBottom:6, paddingLeft:4 }}>{t('appearance')}</div>
          ...
          {/* Language */}
          <div style={{ fontFamily:MONO, fontSize:15, color:COLORS.mute, letterSpacing:'0.1em', textTransform:'uppercase', marginBottom:6, paddingLeft:4 }}>{t('language')}</div>
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding:'12px 20px 16px', display:'flex', gap:14, alignItems:'center',
          ...
          <div style={{ flex:1, minWidth:0 }}>
            ...
            <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginTop:2 }}>{authUser.email}</div>
          </div>
          <div style={{ display:'flex', gap:8, alignItems:'center', flexShrink:0 }}>
            ...
            <button onClick={() => { fbSignOut(); onClose(); }} style={{
              ...
              background:'transparent', fontFamily:SANS, fontSize:15, color:COLORS.mute, cursor:'pointer',
            }}>{t('logout')}</button>
          </div>
        </div>
        <div style={{ overflowY:'auto', flex:1, padding:'14px 16px' }}>
          ...
          <div style={{
            ...
            <div style={{ flex:1, minWidth:0 }}>
              ...
              <div style={{ fontFamily:SANS, fontSize:15, color:COLORS.mute, marginTop:2 }}>{t('companionsDesc')}</div>
            </div>
            <div style={{ display:'flex', gap:8, flexShrink:0 }}>
              ...
              <button onClick={() => { onClose(); setTimeout(() => onAddCompanion(null), 100); }} style={{
                ...
                fontFamily:SANS, fontSize:15, fontWeight:600, color:'#fff',
              }}>{t('addComp')}</button>
            </div>
          </div>
          ...
          {!confirmDelete ? (
            <button onClick={() => setConfirmDelete(true)} style={{
              ...
              fontFamily:SANS, fontSize:15, color:COLORS.mute,
              textAlign:'center',
            ...
            <div style={{
              ...
              <div style={{ fontFamily:SANS, fontSize:15, color:'#B71C1C', lineHeight:1.5, marginBottom:14 }}>
                {t('confirmDeleteDesc')}
              </div>
              {deleteError && (
                <div style={{ fontFamily:SANS, fontSize:15, color:'#C62828', marginBottom:10 }}>{t('deleteError')}</div>
              )}
              <div style={{ display:'flex', gap:8 }}>
    ...
    <div style={{ minHeight:'100vh', background:'#1a1a1a', display:'flex', flexDirection:'column',
      ...
      <div style={{ background:'#C0392B', borderRadius:16, padding:'20px 24px', maxWidth:320, textAlign:'center', width:'100%' }}>
        <div style={{ fontFamily:MONO, fontSize:17, color:'#fff', lineHeight:2.2 }}>
          ...
          <div style={{ fontSize:12, marginTop:4, opacity:0.8 }}>v222</div>
        </div>
      </div>
      <button onClick={async () => {
        try {
