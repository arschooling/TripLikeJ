...
window.TRIP_DEFAULT = {
  ...
  prep: {
    cats: [
      { id:'cat_docs',  name:'핵심 서류', items:['여권','현지 화폐','신용카드','항공권 예약 확인서','숙소 바우처'] },
      { id:'cat_elec',  name:'전자기기',  items:['스마트폰 충전기','보조배터리','이어폰','해외용 어댑터'] },
      { id:'cat_wash',  name:'세면·위생', items:['칫솔','치약','손톱깎이','선크림','휴대용 휴지'] },
      { id:'cat_cloth', name:'의류',      items:['속옷','양말','반팔티','긴팔 옷','바지','겉옷'] },
      { id:'cat_med',   name:'상비약',    items:['타이레놀','소화제','반창고'] },
      { id:'cat_etc',   name:'기타',      items:['미니우산','기내용 목베개','귀마개','안대','썬글라스'] },
    ],
  },
